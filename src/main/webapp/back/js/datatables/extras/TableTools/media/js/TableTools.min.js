...
(function (f, n, g) {
    ...
    TableTools.prototype = {
        ...
        _fnColumnTargets: function (a) {
            ...
            for (e in d)if ("i" != e && "t" != e && 1 == e.length)for (var j = 0, m = d[e].length; j < m; j++)this.dom.print.hidden.push({
                node: d[e][j],
                display: "block"
    ...
    TableTools.BUTTONS = {
        ...
        copy: f.extend({}, TableTools.buttonBase, {
            ...
            fnComplete: function (a, b, c, d) {
                ...
                this.fnInfo("<h6>表格数据已复制</h6><p>复制 " + a + " 行到粘贴板.</p>", 1500)
            }
        }),
        ...
        print: f.extend({}, TableTools.buttonBase, {
            sInfo: "<h6>打印预览</h6><p>请使用您的浏览器打印功能进行打印，打印完毕后按esc键.",
            sMessage: null,
            bShowAll: !0,
            sToolTip: "打印预览",
