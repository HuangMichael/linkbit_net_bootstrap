$.extend(!0, $.fn.dataTable.defaults, {
    ...
    oLanguage: {sLengthMenu: "显示 _MENU_ 条", sSearch: ""}
    ...
    bs_normal: {
        fnInit: function (t, e, i) {
            ...
            $(e).append('<ul class="pagination"><li class="prev disabled"><a href="#"><span class="glyphicon glyphicon-chevron-left"></span>&nbsp;' + n.sPrevious + "</a></li>" + '<li class="next disabled"><a href="#">' + n.sNext + '&nbsp;<span class="glyphicon glyphicon-chevron-right"></span></a></li>' + "</ul>");
            var a = $("a", e);
            $(a[0]).bind("click.DT", {action: "previous"}, r), $(a[1]).bind("click.DT", {action: "next"}, r)
        }, fnUpdate: function (t, e) {
            var i, n, r, a, o, s, l = 5, h = t.oInstance.fnPagingInfo(), c = t.aanFeatures.p, u = Math.floor(l / 2);
            for (h.iTotalPages < l ? (o = 1, s = h.iTotalPages) : h.iPage <= u ? (o = 1, s = l) : h.iPage >= h.iTotalPages - u ? (o = h.iTotalPages - l + 1, s = h.iTotalPages) : (o = h.iPage - u + 1, s = o + l - 1), i = 0, n = c.length; n > i; i++) {
                for ($("li:gt(0)", c[i]).filter(":not(:last)").remove(), r = o; s >= r; r++)a = r == h.iPage + 1 ? 'class="active"' : "", $("<li " + a + '><a href="#">' + r + "</a></li>").insertBefore($("li:last", c[i])[0]).bind("click", function (i) {
        ...
        fnInit: function (t, e, i) {
            ...
            $(e).append(a);
            var o = $("a", e), s = o[0], l = o[1];
            t.oApi._fnBindAction(s, {action: "previous"}, r), t.oApi._fnBindAction(l, {action: "next"}, r), t.aanFeatures.p || (e.id = t.sTableId + "_paginate", s.id = t.sTableId + "_previous", l.id = t.sTableId + "_next", s.setAttribute("aria-controls", t.sTableId), l.setAttribute("aria-controls", t.sTableId))
        }, fnUpdate: function (t) {
            if (t.aanFeatures.p) {
                var e = t.oInstance.fnPagingInfo();
                t.oClasses;
                for (var i = t.aanFeatures.p, n = 0, r = i.length; r > n; n++)0 === e.iPage ? $("li:first", i[n]).addClass("disabled") : $("li:first", i[n]).removeClass("disabled"), e.iPage === e.iTotalPages - 1 || 0 === e.iTotalPages ? $("li:last", i[n]).addClass("disabled") : $("li:last", i[n]).removeClass("disabled")
            }
        }
    }, bs_four_button: {
        fnInit: function (t, e, i) {
            var n = t.oLanguage.oPaginate, r = t.oClasses, a = function (e) {
                t.oApi._fnPageChange(t, e.data.action) && i(t)
            };
            ...
            var o = $("a", e), s = o[0], l = o[1], h = o[2], c = o[3];
            t.oApi._fnBindAction(s, {action: "first"}, a), t.oApi._fnBindAction(l, {action: "previous"}, a), t.oApi._fnBindAction(h, {action: "next"}, a), t.oApi._fnBindAction(c, {action: "last"}, a), t.aanFeatures.p || (e.id = t.sTableId + "_paginate", s.id = t.sTableId + "_first", l.id = t.sTableId + "_previous", h.id = t.sTableId + "_next", c.id = t.sTableId + "_last")
        }, fnUpdate: function (t) {
            if (t.aanFeatures.p) {
                var e = t.oInstance.fnPagingInfo();
                t.oClasses;
                for (var i = t.aanFeatures.p, n = 0, r = i.length; r > n; n++)0 === e.iPage ? ($("li:eq(0)", i[n]).addClass("disabled"), $("li:eq(1)", i[n]).addClass("disabled")) : ($("li:eq(0)", i[n]).removeClass("disabled"), $("li:eq(1)", i[n]).removeClass("disabled")), e.iPage === e.iTotalPages - 1 || 0 === e.iTotalPages ? ($("li:eq(2)", i[n]).addClass("disabled"), $("li:eq(3)", i[n]).addClass("disabled")) : ($("li:eq(2)", i[n]).removeClass("disabled"), $("li:eq(3)", i[n]).removeClass("disabled"))
            }
        }
    }, bs_full: {
        fnInit: function (t, e, i) {
            ...
            if (t.aanFeatures.p) {
                var i, n, r, a, o = t.oInstance.fnPagingInfo(), s = $.fn.dataTableExt.oPagination.iFullNumbersShowPages, l = Math.floor(s / 2), h = Math.ceil(t.fnRecordsDisplay() / t._iDisplayLength), c = Math.ceil(t._iDisplayStart / t._iDisplayLength) + 1, u = "";
                t.oClasses;
                var d, p = t.aanFeatures.p;
                ...
                for (r = 0, a = p.length; a > r; r++)d = p[r], d.hasChildNodes() && ($("li:gt(1)", p[r]).filter(":not(li:eq(-2))").filter(":not(li:eq(-1))").remove(), 0 === o.iPage ? ($("li:eq(0)", p[r]).addClass("disabled"), $("li:eq(1)", p[r]).addClass("disabled")) : ($("li:eq(0)", p[r]).removeClass("disabled"), $("li:eq(1)", p[r]).removeClass("disabled")), o.iPage === o.iTotalPages - 1 || 0 === o.iTotalPages ? ($("li:eq(-1)", p[r]).addClass("disabled"), $("li:eq(-2)", p[r]).addClass("disabled")) : ($("li:eq(-1)", p[r]).removeClass("disabled"), $("li:eq(-2)", p[r]).removeClass("disabled")), $(u).insertBefore("li:eq(-2)", p[r]).bind("click", function (i) {
                    i.preventDefault(), t._iDisplayStart = (parseInt($("a", this).text(), 10) - 1) * o.iLength, e(t)
                }))
            }
        }
    }
