                                ...
                                <div class="box-body">
                                    ...
                                    <table id="datatable2" cellpadding="0" cellspacing="0" border="0"
                                        ...
                                        <c:forEach items="${menuList}" var="menu" varStatus="status">
                                            <tr class="gradeX" id="tr${menu.id}">
                                                <td class="center">${status.index+1}</td>
                                                <td class="center"><a
                                                        href="/back/menu/detail/${menu.id}">${menu.menuName}</a>
                                                </td>
                                                <td class="center">${menu.menuDesc}
                                                </td>
                                                <td class="center">
                                                    <c:if test="${menu.menuType==1}">后台菜单</c:if>
                                                    <c:if test="${menu.menuType!=1}">前台菜单</c:if>
                                                </td>
                                                <td class="center "><a href="/back/menu/edit/${menu.id}">编辑</a>
                                                </td>
                                                <td class="center "><a id="delBtn${menu.id}">删除</a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
